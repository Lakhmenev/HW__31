    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(null=True, validators=[authentication.models.nine_years_older])),
                ('email_address', models.EmailField(max_length=254, unique=True, validators=[authentication.models.except_rambler])),
